...
class Order extends Model
{
    ...
    {
        return ['customer_approved_at' => 'datetime', 'revision_requested_at' => 'datetime', 'final_priced_at' => 'datetime', 'production_started_at' => 'datetime', 'ready_at' => 'datetime', 'completed_at' => 'datetime', 'cancelled_at' => 'datetime', 'archived_at' => 'datetime', 'estimated_subtotal' => 'integer', 'estimated_total' => 'integer', 'final_total' => 'integer', 'amount_paid' => 'integer'];
    }
}
